package com.sphereex.jmh.mysqlx;
...
public final class MySQLX {
    ...
    public static Session getSession() {
        ...
        try {
            in = null == profile || profile.trim().isEmpty() ? new FileInputStream(configurationFile) : MySQLX.class.getResourceAsStream(String.format("/META-INF/profiles/%s.properties", profile));
