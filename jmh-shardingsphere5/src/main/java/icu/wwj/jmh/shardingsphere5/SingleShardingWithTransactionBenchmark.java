...
public class SingleShardingWithTransactionBenchmark {
    ...
    public SingleShardingWithTransactionBenchmark() {
        try {
    ...
    @Group("benchSingleShardingWithTransaction")
    @Benchmark
    public void benchSingleShardingWithTransaction() throws Exception {
